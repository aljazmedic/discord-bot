import { JokeDB, JokeReplyDB, JokeTypeDB, sequelize } from "./Bot/models";
...
const whRegex = new RegExp("^(Who|What|When|Where|Why|Which|Whom|Whose|How many|How much|How)", 'i');
